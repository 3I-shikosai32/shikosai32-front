...
const Ranking: FC = () => (
	<div className="mx-[15px] mt-[25px] w-[95%]">
		<div className="rounded-lg bg-white px-[20px] pt-[15px] pb-[5px] shadow-xl">
			<div className="">
				<div className="text-center text-3xl ">あなたの順位</div>
				<div className="text-center text-sm ">全参加者128人の中で...</div>
				<div className="mb-[50px] flex translate-y-[-20px] justify-center">
					<div className="mr-[10px] translate-y-[55px] text-5xl">#1</div>
			...
			<div className="my-[10px] flex justify-center"><Button className="bg-gradient-to-r from-twitter-g1 to-twitter-g2">ツイートする</Button></div>
		</div>
	</div>
)
