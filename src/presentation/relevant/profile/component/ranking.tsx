	...
	return (
		<div className="mx-[15px] mt-[25px] w-[90%]">
			<div className="rounded-3xl bg-white px-[20px] pt-[15px] pb-[5px] shadow-xl">
				<div>
					<div className="flex translate-y-[-20px] justify-center">
						<div>
							...
							<div className="mb-[50px] flex translate-y-[-20px] justify-center">
								<div className={twMerge("mr-[10px] translate-y-[55px] text-5xl", data.rank === 1 && "text-gold", data.rank === 2 && "text-silver", data.rank === 3 && "text-[#d8b041]")}>#1</div>
								...
								<div className="ml-[10px] translate-y-[60px] text-center">
									...
									<div className="font-body text-3xl font-bold">Dino316</div>
								</div>
							</div>
						</div>
					</div>
