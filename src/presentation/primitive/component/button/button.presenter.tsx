...
import { FC, ReactNode, ComponentPropsWithRef, useMemo, forwardRef } from 'react';
...
const Button: FC<ButtonProps> = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ type, outlined, ghost, circle, className, children, ...props }, ref) => {
    //
          ...
          <motion.button
            ...
            className={twMerge(
              ...
              ghost
                ...
                : 'shadow-z16 hover:shadow-z24 active:shadow-none disabled:shadow-none',
              className,
            )}
            {...props}
          >
